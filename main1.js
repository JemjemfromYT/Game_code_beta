...
window.onload = function(){
  ...
  alert("Objective: You must have atleast 60 score to victory")
...
function startGame(){
  ...
  loadGame();
  alert("I repeat")
  alert("You must have atleast 60 score to win the game bro")
  try{
  ...
  bgSound.loop = true;//bgSound.volume = 0.8;
  ...
  function loadGame(){
    ...
    nextStage.addEventListener("click", function(){
      window.location.href="1CodeIndex.html"
    });
    
            }
            else {
              alert("you loss, please try again")
startSound.src = "introMlbb.mp3";
            }
                      try{
                        highScoreSound.play().catch(function(e){});
    ...
    function shoot(){
      if(arrow1.vis && arrow2.vis && arrows != -1){
        ...
        totalArr--;
        playArrowSound(); // Call the new sound function
      }
      arrows++;
    }
